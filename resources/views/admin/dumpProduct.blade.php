            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <p style="white-space: pre-wrap">{{ $item->bahan}}</p>
                        </td>
                        <td>
                            <p style="white-space: pre-wrap">{{ $item->masak}}</p>
                        </td>
                            ...
                            <div class="modal-content">
                                <form action='/admin/product/{{ $item->id }}' method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label>Bahan</label>
                                            <textarea name="bahan" class="form-control" required>{{ $item->bahan }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Cara Masak</label>
                                            <textarea name="masak" class="form-control" required>{{ $item->masak}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Harga</label>
                    ...
                    <div class="modal-content">
                        <form action='' method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Cara Masak</label>
                                    <textarea name="masak" class="form-control" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Harga</label>
                                    <div class="input-group">
