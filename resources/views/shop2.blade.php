...
<div class="services_section layout_padding">
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a href="/detail" class="box_main">
                        ...
                        <div class="right_main">
                            <h6 class="milk_text">Bola bola</h6>
                            <h1 class="price_text">15k</h1>
                        </div>
                    </a>
                    <a href="/detail" class="box_main">
                        ...
                        <div class="right_main">
                            <h6 class="milk_text">Ayam mail</h6>
                            <h1 class="price_text">15k</h1>
                        </div>
                    </a>
                </div>
        ...
        <div class="next_page_button">
            <a href="#" id="next_page_link">Next Page</a>
            <p id="page_number">Page 3</p>
        </div>
...
<!-- services section end -->
   ...
   <script>
    // Ambil elemen tombol Next Page
    var nextPageLink = document.getElementById("next_page_link");

    // Tambahkan event listener untuk mendeteksi klik tombol Next Page
    nextPageLink.addEventListener("click", function(event) {
        // Ambil nomor halaman dari URL
        var currentPage = window.location.pathname.match(/(\d+)$/);
        
        // Periksa apakah nomor halaman ditemukan
        if (currentPage) {
            // Ambil nomor halaman saat ini dan tambahkan 1 untuk mendapatkan halaman berikutnya
            var nextPage = parseInt(currentPage[0]) + 1;
            // Ubah URL tombol Next Page sesuai dengan halaman berikutnya
            nextPageLink.href = "/page-" + nextPage;
            // Perbarui teks keterangan halaman
            document.getElementById("page_number").textContent = "Page " + nextPage;
        }
    });
</script>
