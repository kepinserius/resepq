    ...
    <div class="container h-100 py-5">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-10">
          ...
          <p class="lead fw-normal mb-2" style = "margin-bottom : 20px;">Alamat Pengiriman: <br>Fatralia Della Ayu S<br>
        081334235014<br>Perum Asrikaton Indah Blok F4/4, Jl. Kebun Sirih 3, Pakis-Malang</p>
        <hr style="border-top: 1px solid black;">
          ...
          <p class="lead fw-normal mb-2" style = "margin-bottom : 20px;">Metode Pembayaran: <br>COD</p>
            ...
            <p class="lead fw-normal mb-2" style = "margin-bottom : 20px;">Total Pemesanan: <br>Rp. 80.000,-</p>

          <div class="card">
            <div class="card-body">
              <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-warning btn-block btn-lg">Checkout</button>
            </div>
          </div>
